...
function entradaNormal(llamadoPorJavascript = false){
    ...
    switch(entrada1.value.toLowerCase()){
        ...
        case "infinity":
            ...
            significandDouble.value = "00 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000";
        ...
        case "qnan":
            ...
            significandDouble.value = "1X XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX";
            huboEjemplo = true;
            break;
        case "snan":
            entrada2.value = "Look the properties. The X represents that don't matter if the bit is 1 or 0";
            ...
            significandDouble.value = "0X XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX";
            huboEjemplo = true;
            break;
        default:
