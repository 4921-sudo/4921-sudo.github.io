...
textResult.value = (textResult.value).toUpperCase();

let parteEnteraYDecimal = textResult.value.split(".");

if(parteEnteraYDecimal.length == 1){
    return;
}

if (parteEnteraYDecimal[1].length >= 50){
    parteEnteraYDecimal[1] = parteEnteraYDecimal[1].substring(0, 50);
}

textResult.value = (parteEnteraYDecimal[0] + "." + parteEnteraYDecimal[1]).toUpperCase();
